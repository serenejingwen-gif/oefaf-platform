...
We as members, contributors, and maintainers of the OEFAF platform pledge to
...
diverse, inclusive, and healthy community oriented toward the public-interest
...
- Focusing on what is best not just for us as individuals, but for the overall
  community and the public-interest purpose of the platform.
...
- Submitting proprietary, confidential, or non-public data or code (see
  `CONTRIBUTING.md` — the platform accepts public and openly licensed inputs
  only).
...
`<JING_WEN_TO_FILL: code-of-conduct contact email>`. All complaints will be
reviewed and investigated promptly and fairly. All community maintainers are
